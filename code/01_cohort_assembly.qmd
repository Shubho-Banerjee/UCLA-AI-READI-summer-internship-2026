...
The heatmap shows the availability of CGM, wearable, and clinical data for each participant in the AI-READI v3 mini dataset. Every participant has all three modalities available, indicating there are no missing data for these key sources in the mini dataset. This complete modality coverage makes the dataset well suited for developing and testing multimodal analysis workflows.
...
The boxplots compare the distribution of average CGM glucose across the four study groups. The study groups show different glucose distributions, with some groups having higher median glucose levels and greater variability than others. These descriptive patterns provide an initial view of glycemic differences that can be explored further using more detailed CGM metrics in later analyses.
